...
def get_text(objIdLst):
    email=input("E-mailアドレスを入力してください")
    ...
    with sync_playwright() as playwriht:
        ...
        page.fill('div.MuiFormControl-root:nth-child(2) > div:nth-child(1) > div:nth-child(1) > input:nth-child(1)', email)
        page.fill(".MuiInputBase-inputAdornedEnd", password)
